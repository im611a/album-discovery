...
export function AlbumGrid({ albums, reasons, actions = "compact", highlight, headingLevel = 2 }: { albums: PublishedAlbumSummary[]; reasons?: Record<string, string>; actions?: "compact" | "full"; highlight?: string; headingLevel?: 2 | 3 }) {
