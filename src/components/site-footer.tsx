...
export function SharedFooter() {
  return <footer className="site-footer"><div className="page-container site-footer__inner">
    ...
    <nav aria-label="页尾目录"><Link href="/discover">专辑目录</Link><Link href="/artists">艺人档案</Link><GlobalSearchTrigger>搜索档案</GlobalSearchTrigger><Link href="/about">数据与本站</Link><Link href="/settings">隐私与设置</Link></nav>
