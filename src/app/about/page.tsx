...
export default function AboutPage() {
  return <SiteShell mainClassName="pa-reading-page">
    <PageHeader eyebrow="Album Discovery Archive" title="关于本站">这是一个面向中文读者的静态专辑档案与发现工具：用真实目录、可说明的分类和本机偏好，帮助你找到下一张值得完整聆听的专辑。</PageHeader>
