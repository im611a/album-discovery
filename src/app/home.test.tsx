...
describe("physical archive home", () => {
  it("renders the complete static physical archive without old gallery UI", () => {
    ...
    expect(awakening?.querySelectorAll("[data-album-cover]")).toHaveLength(0);
    ...
    expect(container.querySelectorAll('[data-featured-role="previous"]')).toHaveLength(3);
    expect(container.querySelectorAll('[data-featured-role="active"]')).toHaveLength(3);
    expect(container.querySelectorAll('[data-featured-role="next"]')).toHaveLength(3);
