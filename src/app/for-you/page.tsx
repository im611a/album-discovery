...
export default function ForYouPage() { return <div className="site-shell"><SiteHeader /><main className="page-main page-container" id="main-content"><header className="page-intro"><p className="eyebrow">本机计算 · 有理由的选择</p><h1>为你推荐</h1><p>推荐由核心流派、相关流派、氛围特征、场景、年代与显式反馈确定；没有远程 AI，也不会上传你的口味。</p></header><RecommendationCatalog /></main><SiteFooter /></div>; }
